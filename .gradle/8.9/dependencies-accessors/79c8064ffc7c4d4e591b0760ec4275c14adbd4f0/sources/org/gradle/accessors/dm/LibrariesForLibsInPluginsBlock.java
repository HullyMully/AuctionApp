...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class CloudinaryLibraryAccessors extends SubDependencyFactory {
        private final CloudinaryAndroidLibraryAccessors laccForCloudinaryAndroidLibraryAccessors = new CloudinaryAndroidLibraryAccessors(owner);
        private final CloudinaryCloudinaryLibraryAccessors laccForCloudinaryCloudinaryLibraryAccessors = new CloudinaryCloudinaryLibraryAccessors(owner);

        public CloudinaryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>cloudinary.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CloudinaryAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCloudinaryAndroidLibraryAccessors;
        }

        /**
         * Group of libraries at <b>cloudinary.cloudinary</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CloudinaryCloudinaryLibraryAccessors getCloudinary() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCloudinaryCloudinaryLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CloudinaryAndroidLibraryAccessors extends SubDependencyFactory {

        public CloudinaryAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>download</b> with <b>com.cloudinary:cloudinary-android-download</b> coordinates and
         * with version reference <b>comCloudinaryCloudinaryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getDownload() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("cloudinary.android.download");
        }

        /**
         * Dependency provider for <b>preprocess</b> with <b>com.cloudinary:cloudinary-android-preprocess</b> coordinates and
         * with version reference <b>comCloudinaryCloudinaryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getPreprocess() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("cloudinary.android.preprocess");
        }
     ...
     */
    @Deprecated
    public static class CloudinaryCloudinaryLibraryAccessors extends SubDependencyFactory {

        public CloudinaryCloudinaryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.cloudinary:cloudinary-android</b> coordinates and
         * with version reference <b>cloudinaryAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("cloudinary.cloudinary.android");
        }
    ...
    public static class ComCloudinaryCloudinaryLibraryAccessors extends SubDependencyFactory {
        private final ComCloudinaryCloudinaryAndroidLibraryAccessors laccForComCloudinaryCloudinaryAndroidLibraryAccessors = new ComCloudinaryCloudinaryAndroidLibraryAccessors(owner);

        public ComCloudinaryCloudinaryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.cloudinary.cloudinary.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComCloudinaryCloudinaryAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComCloudinaryCloudinaryAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComCloudinaryCloudinaryAndroidLibraryAccessors extends SubDependencyFactory {
        private final ComCloudinaryCloudinaryAndroidV302LibraryAccessors laccForComCloudinaryCloudinaryAndroidV302LibraryAccessors = new ComCloudinaryCloudinaryAndroidV302LibraryAccessors(owner);

        public ComCloudinaryCloudinaryAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.cloudinary.cloudinary.android.v302</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComCloudinaryCloudinaryAndroidV302LibraryAccessors getV302() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComCloudinaryCloudinaryAndroidV302LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComCloudinaryCloudinaryAndroidV302LibraryAccessors extends SubDependencyFactory {

        public ComCloudinaryCloudinaryAndroidV302LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x2</b> with <b>com.cloudinary:cloudinary-android</b> coordinates and
         * with version reference <b>comCloudinaryCloudinaryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getX2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("com.cloudinary.cloudinary.android.v302.x2");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>cloudinaryAndroidVersion</b> with value <b>1.31.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCloudinaryAndroidVersion() { return getVersion("cloudinaryAndroidVersion"); }

        /**
         * Version alias <b>comCloudinaryCloudinaryAndroid</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComCloudinaryCloudinaryAndroid() { return getVersion("comCloudinaryCloudinaryAndroid"); }
